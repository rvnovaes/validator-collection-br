...
well_formed_lawsuits_numbers = ['0000013-59.2013.8.05.0250', '0611925-60.2017.8.04.0001', '0004268-07.2016.8.06.0063', '0005714-53.2008.8.18.0140']
malformed_lawsuits_numbers = ['0000023-59.2013.8.05.0250', '0611925-60.8888.8.04.0010', '7770000-07.2016.8.06.0063', '0005714-53.2008.8.18.0000']
...
customers = ["DIRECIONAL JUDICIAL", "DIRECIONAL EXTRAJUDICIAL", "MRV JUDICIAL", "MRV EXTRAJUDICIAL", "PRECON", "BTM", "SEMPRE EDITORA EXTRAJUDICIAL", "SANTO ANDRÉ JUDICIAL", "SANTO ANDRÉ EXTRAJUDICIAL", "KINEA JUDICIAL", "KINEA EXTRAJUDICIAL", "ITAU", "SEMPRE EDITORA JUDICIAL"]

negotiation_status = ["CONTATO INICIAL", "EM ANDAMENTO", "AVANÇADA", "QUITAÇÃO INTEGRAL", "RENEGOCIAÇÃO EFETIVADA", "RENEGOCIAÇÃO QUITADA", "INADIMPLÊNCIA APÓS ACORDO", "RECUSA NÃO TEM CONDIÇÕES", "RECUSA NÃO TEM INTERESSE"]
...
court_decision = ["NÃO", "PROCEDENTE", "PARCIALMENTE PROCEDENTE", "IMPROCEDENTE", "EXTINTO SEM JULGAMENTO DO MÉRITO", "HOMOLOGADO ACORDO"]

appeal = ["SIM", "NÃO"]

res_judicata = ["SIM", "NÃO"]

# for number in well_formed_lawsuits_numbers:
#     cnj_number1 = CNJ(number)
#     print(cnj_number1)
#     print('============================')
#
# for number in malformed_lawsuits_numbers:
#     cnj_number1 = CNJ(number)
#     print(cnj_number1)
#     print('============================')

#
# for cnpj in well_formed_cnpj_numbers:
#     cnpj = CNPJ(cnpj)
#     print(cnpj)
#     print('============================')


# print(validates_list('COCA-COLA', customers))
# print(validates_list('negociado', negotiation_status))
# print(validates_list('em andamento', deal))
# print(validates_list('pagamento parcelado', deal_type))
# print(validates_list('devedor', customers_status))
# print(validates_list('inativo', suspended_action))
